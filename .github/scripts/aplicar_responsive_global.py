...
onu='<script src="onu-control-modelo-v1.js?v=20260818-1316"></script>'
for p in Path('.').glob('*.html'):
    ...
    if p.name=='instalacion-ejecucion.html':
        # Compatibilidad: si una versión anterior apuntó al endpoint temporal, devolverla al backend estable.
