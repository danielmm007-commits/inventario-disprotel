(()=>{
  ...
  const iniciar=()=>{
    ...
    restaurar();
    if(!document.getElementById('mesaTecnicaFernandoScript')){const s=document.createElement('script');s.id='mesaTecnicaFernandoScript';s.src='mesa-tecnica-fernando-v1.js?v=20260918-2310';document.head.appendChild(s)}
  };
